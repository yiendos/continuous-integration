<?php  //[STAMP] f4dbb76cf84529f7267e1f14eb2b76ea
...
trait WebGuyActions
{
     ...
     *
     *
     * @see \Helper\DbHelper::executeQuery()
     */
     ...
     *
     *
     * @see \Helper\MailCatcherHelper::deleteEmails()
     */
    public function deleteEmails() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('deleteEmails', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\MailCatcherHelper::checkEmails()
     */
    public function checkEmails($customisation = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkEmails', func_get_args()));
    }
}
